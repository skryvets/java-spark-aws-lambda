# spark-cloud serverless API
The spark-cloud project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
    ...
    "Stacks": [
        {
            ...
            "Description": "AWS Serverless Spark API - com.sergeome::spark-cloud", 
            "Tags": [], 
            "Outputs": [
                {
                    "Description": "URL for application",
                    "ExportName": "SparkCloudApi",  
                    "OutputKey": "SparkCloudApi",
